...
/**
 * REST controller for managing {@link com.itgstore.iptv.domain.Abonnement}.
 */
@RestController
@RequestMapping("/api")
public class AbonnementResource {
    ...
    public ResponseEntity<AbonnementDTO> updateAbonnement(@Valid @RequestBody AbonnementDTO abonnementDTO) throws URISyntaxException {
