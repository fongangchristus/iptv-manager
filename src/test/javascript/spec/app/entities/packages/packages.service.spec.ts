...
describe('Service Tests', () => {
  describe('Packages Service', () => {
    ...
    let expectedResult: IPackages | IPackages[] | boolean | null;
    beforeEach(() => {
      ...
      elemDefault = new Packages(0, 'AAAAAAA', 'AAAAAAA', 0, 'AAAAAAA', 'AAAAAAA');
    });
